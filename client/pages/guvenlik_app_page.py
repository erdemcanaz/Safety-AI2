...
class GuvenlikApp():
    ...
    def do_page(self, program_state:List[int]=None, cv2_window_name:str = None,  ui_frame:np.ndarray = None, active_user:object = None, mouse_input:object = None):
        ...
        cv2.putText(ui_frame, today_shift+today_date, (470, 76), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (169, 96, 0), 2, cv2.LINE_AA)
        cv2.rectangle(ui_frame, (484, 93), (484+int(388*percentage), 107), (169, 96, 0), -1)
