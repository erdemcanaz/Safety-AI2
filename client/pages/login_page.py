...
class LoginPage():
    ...
    CONSTANTS = {
        ...
        "username_bbox": (222, 481, 800, 547),
        "username_text_bleft": (300, 527),
        "password_bbox": (222, 605, 800,667),
    ...
    def do_page(self, program_state:List[int]=None, cv2_window_name:str = None,  ui_frame:np.ndarray = None, active_user:object = None, mouse_input:object = None):
        ...
        elif pressed_key == 9: #TAB
            if self.secondary_mode == 1:
                self.secondary_mode = 2
        ...
        if self.secondary_mode == 1:
            cv2.line(ui_frame, (self.CONSTANTS["username_bbox"][0]-10, self.CONSTANTS["username_bbox"][1]), (self.CONSTANTS["username_bbox"][0]-10, self.CONSTANTS["username_bbox"][3]), (170, 95, 0), 9)
        elif self.secondary_mode == 2:
            cv2.line(ui_frame, (self.CONSTANTS["password_bbox"][0]-10, self.CONSTANTS["password_bbox"][1]), (self.CONSTANTS["password_bbox"][0]-10, self.CONSTANTS["password_bbox"][3]), (170, 95, 0), 9)
