...
class OzetApp():
    ...
    def __plot_shift_summary(self, ui_frame:np.ndarray):
        ...
        cv2.putText(ui_frame, f"{self.__format_count_to_hr(self.mock_shift_data['total_person_analyzed'])}", (554, 221), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (154, 108, 15), 1)
        cv2.putText(ui_frame, f"{self.__format_count_to_hr(self.mock_shift_data['total_frame_analyzed'])}", (554, 272), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (154, 108, 15), 1)
        ...
        cv2.putText(ui_frame, f"{self.__format_count_to_hr(self.mock_shift_data['total_restricted_area_rejected'])}", (1213, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (154, 108, 15), 1)
        ...
        cv2.putText(ui_frame, f"{self.__format_count_to_hr(self.mock_shift_data['shift_person_analyzed'])}", (554, 400), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (154, 108, 15), 1)
        cv2.putText(ui_frame, f"{self.__format_count_to_hr(self.mock_shift_data['shift_frame_analyzed'])}", (554, 451), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (154, 108, 15), 1)
