...
class KaliteApp():
    ...
    def do_page(self, program_state:List[int]=None, cv2_window_name:str = None,  ui_frame:np.ndarray = None, active_user:object = None, mouse_input:object = None):
        ...
        # Draw UI
        picasso.draw_image_on_frame(ui_frame, image_name="kalite_app_page_template", x=0, y=0, width=1920, height=1080, maintain_aspect_ratio=True)  
        ...
        cv2.putText(ui_frame, today_shift+today_date, (390, 76), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (169, 96, 0), 2, cv2.LINE_AA)
        cv2.rectangle(ui_frame, (381, 93), (381+int(490*percentage), 107), (169, 96, 0), -1)
