...
class KurallarApp():
    ...
    def do_page(self, program_state:List[int]=None, cv2_window_name:str = None,  ui_frame:np.ndarray = None, active_user:object = None, mouse_input:object = None):
        ...
        # Draw UI
        picasso.draw_image_on_frame(ui_frame, image_name="kurallar_app_page_template", x=0, y=0, width=1920, height=1080, maintain_aspect_ratio=True)  
        ...
        cv2.putText(ui_frame, "| "+today_date+" | "+today_shift, (395, 93), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (228, 173, 0), 2, cv2.LINE_AA)                                                                          
