...
class WhichAppPage:    
    def __init__(self, api_dealer:object, popup_dealer:object):
        ...
        self.user_authorizations = self.api_dealer.get_authorizations() #[True, 200, {'authorizations': [{'date_created': '2024-08-29 09:53:09', 'date_updated': '2024-08-29 09:53:09', 'user_uuid': '745dacca-1cf4-43ca-82fc-6603ea983e3c', 'authorization_uuid': 'f624398f-f137-4fa7-9296-1d4e066689f8', 'authorization_name': 'MENAGE_USERS'}]
        ...
        authorized_apps = [ {"COLUMN_0": app['authorization_name']} for app in self.user_authorizations[2]['authorizations']]
