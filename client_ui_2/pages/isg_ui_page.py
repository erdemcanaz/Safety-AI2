                    ...
                    for count_dict in counts_list:
                        ...
                        if 'detected_hardhat_count' in count_dict:
                            ...
                            picasso.draw_text_on_frame(
                                ...
                                position=(int(main_frame_location[0] * self.page_frame.shape[1]), int(main_frame_location[1] * self.page_frame.shape[0] + main_frame_height + 250)),
                                area_size=(int(main_frame_width/2), int(20)),
                                alignment='center',
                                font=cv2.FONT_HERSHEY_SIMPLEX, 
                                font_scale=2,
                        ...
                        if 'detected_restricted_area_count' in count_dict:
                            ...
                            picasso.draw_text_on_frame(
                                ...
                                position=(int(main_frame_location[0] * self.page_frame.shape[1]+int(main_frame_width/2)), int(main_frame_location[1] * self.page_frame.shape[0] + main_frame_height + 250)),
                                area_size=(int(main_frame_width/2), int(20)),
                                alignment='center',
                                font=cv2.FONT_HERSHEY_SIMPLEX, 
                                font_scale=2,
