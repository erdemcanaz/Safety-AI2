...
CAMERA_DECODING_RANDOMIZATION_RANGE = [0, 0.5] # The range of randomization for the decoding of the camera frames in seconds. Other frames are just grabbed and not decoded.
