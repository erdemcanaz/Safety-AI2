...
PARAM_EVALUATION_TIME_UPDATE_FACTOR = 0.1 # New evaluation time = old evaluation time * (1 - PARAM_EVALUATION_TIME_UPDATE_FACTOR) + new evaluation time * PARAM_EVALUATION_TIME_UPDATE_FACTOR
