...
CAMERA_DEFAULT_FETCHING_DURATION_SECONDS = 1 # Used to calculate randomization range for fetching delay
CAMERA_FETCH_DELAY_SAFETY_MARGIN = 5 # Used to increase the fetching delay to prevent bottlenecking. Basically the max delay is calculated by multiplying the default fetching duration by the number of cameras and this safety margin
